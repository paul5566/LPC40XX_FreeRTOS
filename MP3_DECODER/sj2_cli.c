...
void sj2_cli__init(void) {
  ...
  //----------------------------------------------------------------------------------------------------------------------------------
  static app_cli__command_s hello_back = {
      .command_name = "hello", .help_message_for_command = "hello\n", .app_cli_handler = cli__hello_back};
  static app_cli__command_s task_control = {.command_name = "taskcontrol",
                                            .help_message_for_command = "taskcontrol suspend/resume task_name\n",
                                            .app_cli_handler = cli__task_control};
  static app_cli__command_s mp3_play = {
      .command_name = "play", .help_message_for_command = "play song_name.mp3\n", .app_cli_handler = cli__mp3_play};
  ...
  //----------------------------------------------------------------------------------------------------------------------------------
  app_cli__add_command_handler(&sj2_cli_struct, &hello_back);
